    ...
    const sendMessage = async () => {
        ...
        try {
            ...
            socket.emit('send_message', {
                ...
                senderKey: encryptedData.contentForSender // We store the boxed content for sender in senderKey field
            });
        ...
        <ScreenWrapper style={styles.container}>
            <View style={styles.header}>
                ...
                <View style={styles.headerInfo}>
                    <Text style={[styles.headerName, { color: theme.text }]}>{recipient?.fullName}</Text>
