...
export default function MaidDisputesScreen() {
    ...
    const [disputes] = useState([
        {
            id: '1',
            contractTitle: 'House Cleaning at Alex',
            reason: 'Payment delay',
            status: 'OPEN',
            createdAt: '2026-02-12',
            description: 'The employer has not processed the payment after job completion.'
        },
    ]);
